...
const points= 19;
  ...
  return (
    ...
    <Alert variant="warning" className='box'>
      ...
      <hr />
      {points <= 20 ? (<Button className='unlocked'>Play Level 2</Button>) : (<Button className='notunlocked' disabled >Beat level 1 to Unlock</Button>)}
    </Alert>
    <Alert variant="danger" className='box'>
      ...
      <hr />
      {points <= 20 ? (<Button className='unlocked'>Play Level 3</Button>) : (<Button className='notunlocked' disabled >Beat level 2 to Unlock</Button>)}
    </Alert>
    <Alert variant="danger" className='box'>
      ...
      <hr />
      {points <= 20 ? (<Button className='unlocked'>Play Level 4</Button>) : (<Button className='notunlocked' disabled >Beat level 3 to Unlock</Button>)}
    </Alert>
    <Alert variant="danger" className='box'>
      ...
      <hr />
      {points <= 20 ? (<Button className='unlocked'>Play Level 5</Button>) : (<Button className='notunlocked' disabled >Beat level 4 to Unlock</Button>)}
    </Alert>
    </>
  );
}
